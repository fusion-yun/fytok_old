...
c
c Compile this mexfile on Deneb using : /usr/local/matlab5/bin/mex -f mexopts_glf.sh zglfmex.f blas_zgeev.o callglf2d.o  glf2d.o r8tomsqz.o zgeev.o xtverb.o
...
c        ne_m(j)   = 0.0
c        ni_m(j)   = 0.0
        ns_m(j)   = 0.0  ! densite ions rapides, pas encore connectee ...(idengrad = 2)
c
