...
*
*  RWORK   (workspace) REAL*8 array, dimension (2*N)
*
*  INFO    (output) INTEGER
*          = 0:  successful exit
...
*     .. Local Scalars ..
     ...
     $                   IWRK, K, MAXB, MAXWRK, MINWRK, NOUT
      REAL*8           ANRM, BIGNUM, CSCALE, EPS, SCL, SMLNUM
      complex*16        TMP
*     ..
*     .. Local Arrays ..
      LOGICAL            SELECT( 1 )
...
*     .. External Subroutines ..
      !PIS External           XERBLA, ZDSCAL, ZGEBAK, ZGEBAL, ZGEHRD, ZHSEQR,
      !PIS External $                   ZLACPY, ZLASCL, ZSCAL, ZTREVC, ZUNGHR
*     ..
*     .. External Functions ..
      !PIS LOGICAL            LSAME
      !PIS INTEGER            IDAMAX, ILAENV
      !PIS REAL*8           DLAMCH, DZNRM2, ZLANGE
      !PIS External           LSAME, IDAMAX, ILAENV, DLAMCH, DZNRM2, ZLANGE
*     ..
*     .. Intrinsic Functions ..
...
*
*  SCALE   (input) REAL*8         array, dimension (N)
...
*     ..
*     .. External Subroutines ..
       !PIS  EXTERNAL           XERBLA, ZDSCAL, ZSWAP
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
*  SCALE   (output) REAL*8     array, dimension (N)
...
*     .. Local Scalars ..
      ...
      REAL*8           C, CA, F, G, R, RA, S, SFMAX1, SFMAX2, SFMIN1,
     $                   SFMIN2
      COMPLEX*16        CDUM
*     ..
*     .. External Functions ..
      ...
      !PIS INTEGER            IZAMAX
      !PIS REAL*8           DLAMCH
      !PIS External           LSAME, IZAMAX, DLAMCH
*     ..
*     .. External Subroutines ..
      !PIS External           XERBLA, ZDSCAL, ZSWAP
*     ..
...
*     ..
*     .. External Subroutines ..
      !PIS External           XERBLA, ZLARF, ZLARFG
*     ..
*     .. Intrinsic Functions ..
...
*     ..
*     .. External Subroutines ..
      !PIS External           XERBLA, ZGEHD2, ZGEMM, ZLAHRD, ZLARFB
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*     .. Local Scalars ..
     ...
     $                   MAXB, NH, NR, NS, NV
      REAL*8           OVFL, RTEMP, SMLNUM, TST1, ULP, UNFL
...
*     .. External Functions ..
      !PIS LOGICAL            LSAME
      !PIS INTEGER            ILAENV, IZAMAX
      !PIS REAL*8           DLAMCH, DLAPY2, ZLANHS
      !PIS External           LSAME, ILAENV, IZAMAX, DLAMCH, DLAPY2, ZLANHS
*     ..
*     .. External Subroutines ..
      !PIS External           XERBLA, ZCOPY, ZDSCAL, ZGEMV, ZLACPY, ZLAHQR,
      !PIS External $                   ZLARFG, ZLARFX, ZLASET, ZSCAL
*     ..
*     .. Intrinsic Functions ..
...
*     .. Local Scalars ..
      ...
      REAL*8           H10, H21, RTEMP, S, SMLNUM, T2, TST1, ULP
...
*     ..
*     .. External Functions ..
      !PIS REAL*8           DLAMCH, ZLANHS
      !PIS COMPLEX*16        ZLADIV
      !PIS External           DLAMCH, ZLANHS, ZLADIV
*     ..
*     .. External Subroutines ..
      !PIS External           ZCOPY, ZLARFG, ZSCAL
*     ..
*     .. Intrinsic Functions ..
...
*     .. Local Scalars ..
      INTEGER            I
      COMPLEX*16        EI !PIS f90 convergence
*     ..
*     .. External Subroutines ..
      !PIS External           ZAXPY, ZCOPY, ZGEMV, ZLACGV, ZLARFG, ZSCAL,
      !PIS External $                   ZTRMV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN
...
*
      ...
      REAL*8         FUNCTION ZLANGE( NORM, M, N, A, LDA, WORK )
*
*  -- LAPACK auxiliary routine (version 3.0) --
*     Univ. of Tennessee, Univ. of California Berkeley, NAG Ltd.,
*     Courant Institute, Argonne National Lab, and Rice University
...
*
      ...
      REAL*8         FUNCTION ZLANHS( NORM, N, A, LDA, WORK )
*
*  -- LAPACK auxiliary routine (version 3.0) --
*     Univ. of Tennessee, Univ. of California Berkeley, NAG Ltd.,
*     Courant Institute, Argonne National Lab, and Rice University
...
*     ..
*     .. External Subroutines ..
      !PIS External           ZCOPY, ZGEMM, ZLACGV, ZTRMM
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          DCONJG
*     ..
...
*     ..
*     .. External Functions ..
      !PIS REAL*8           DLAMCH, DLAPY3, DZNRM2
      !PIS COMPLEX*16        ZLADIV
      !PIS External           DLAMCH, DLAPY3, DZNRM2, ZLADIV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          ABS, DBLE, DCMPLX, DIMAG, SIGN
*     ..
*     .. External Subroutines ..
      !PIS External           ZDSCAL, ZSCAL
*     ..
*     .. Executable Statements ..
*
      IF( N.LE.0 ) THEN
...
*     ..
*     .. External Subroutines ..
      !PIS External           ZGEMV, ZLACGV, ZTRMV
*     ..
*     .. External Functions ..
      !PIS LOGICAL            LSAME
      !PIS External           LSAME
...
*
*  CNORM   (input or output) REAL*8         array, dimension (N)
*
...
*     .. External Functions ..
      !PIS LOGICAL            LSAME
      !PIS INTEGER            IDAMAX, IZAMAX
      !PIS REAL*8           DLAMCH, DZASUM
      !PIS COMPLEX*16        ZDOTC, ZDOTU, ZLADIV
      !PIS External           LSAME, IDAMAX, IZAMAX, DLAMCH, DZASUM, ZDOTC,
      !PIS External$                   ZDOTU, ZLADIV
*     ..
*     .. External Subroutines ..
      !PIS External           DSCAL, XERBLA, ZAXPY, ZDSCAL, ZTRSV
*     ..
*     .. Intrinsic Functions ..
...
*
*  RWORK   (workspace) REAL*8         array, dimension (N)
*
*  INFO    (output) INTEGER
*          = 0:  successful exit
*          < 0:  if INFO = -i, the i-th argument had an illegal value
...
*     .. External Functions ..
      ...
      !PIS INTEGER            IZAMAX
      !PIS REAL*8           DLAMCH, DZASUM
      !PIS External           LSAME, IZAMAX, DLAMCH, DZASUM
*     ..
*     .. External Subroutines ..
      !PIS External           XERBLA, ZCOPY, ZDSCAL, ZGEMV, ZLATRS
*     ..
*     .. Intrinsic Functions ..
...
*     ..
*     .. External Subroutines ..
      !PIS External           XERBLA, ZLARF, ZSCAL
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*     ..
*     .. External Subroutines ..
      !PIS External           XERBLA, ZLARFB, ZLARFT, ZUNG2R
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*  =========
*
*  SMALL   (input/output) REAL*8        
*          On entry, the underflow threshold as computed by DLAMCH.
*          On exit, if LOG10(LARGE) is sufficiently large, the square
*          root of SMALL, otherwise unchanged.
*
*  LARGE   (input/output) REAL*8        
...
*     ..
*     .. External Subroutines ..
      !PIS External           DLAMC1, DLAMC4, DLAMC5
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          ABS, MAX, MIN
*     ..
