...
class RadioGrid(Profiles):
    """Radial grid	"""

    def __init__(self, cache=None,  *args, psi_axis=None, psi_boundary=None, rho_pol_norm=129, **kwargs):
        super().__init__(cache, *args, x_axis=rho_pol_norm, **kwargs)
